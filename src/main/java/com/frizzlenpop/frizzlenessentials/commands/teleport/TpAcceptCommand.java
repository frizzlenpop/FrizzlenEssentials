...
public class TpAcceptCommand extends BaseCommand {
    ...
    public TpAcceptCommand(FrizzlenEssentials plugin) {
        super(plugin, "frizzlenessentials.tpaccept", true);
    }
    ...
    protected boolean execute(CommandSender sender, Command command, String label, String[] args) {
        ...
        boolean success = plugin.getTeleportManager().acceptTeleportRequest(player);
